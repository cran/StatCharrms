...
\item	 \hypertarget{R4}{Groeneveld, R. and Meeden, G. (1984). Measuring Skewness and Kurtosis. 
 ...
 \item  \hypertarget{R13}{Terpstra, T. J. (1952). The asymptotic normality and consistency of Kendall's test against trend, when ties are present in one ranking. \textit{Indagationes Mathematicae} \bold{14}:327\textemdash{}333.}	
